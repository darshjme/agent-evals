...
If you discover a security vulnerability in **agent-evals**, please report it responsibly.
...
Subject: `[SECURITY] agent-evals - Brief description`
...
This policy covers the `agent-evals` Python package and its direct dependencies.

## Security Best Practices

When using `agent-evals` in production:
